  ...
  <form id="form" method="post" enctype="multipart/form-data" onchange="checkFileSize(this)" novalidate>
    ...
    <span class="fw-bold fst-italic fs-5 textCustom">Documentos</span><br>
      ...
      <div class="row mt-3 mb-3">
          ...
          <input disabled type="number" id="folioCot" name="folioCot" class="form-control" value="<?php if(isset($folioCot)){echo $folioCot;}?>">
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="row mb-3">
          <div class="col-md-6 mb-2">
            <input type="text" class="form-control form-input" placeholder="Calle" id="calle" name="calle" value="<?php if(isset($calle)){echo $calle;}?>"  required>
            <div class="invalid-feedback">Introduce tu calle</div>
          </div>
          <div class="col-md-3 mb-2">
            <input type="text" class="form-control form-input" placeholder="Número" id="numero" name="numero" value="<?php if(isset($numero)){echo $numero;}?>" required>
            <div class="invalid-feedback">Introduce tu numero</div>
          </div>
          <div class="col-md-3 mb-2">
            <input type="number" class="form-control form-input" placeholder="Codigo Postal" id="cp" name="codigoPostal" required>
      ...
      <div class="mb-3">
        ...
        <div class="col-md-4 mb-2">
          ...
          <div class="col-md-4 mb-2">
          <select class="form-select" id="colonia" name="colonia" aria-label="Default select example" required>
      ...
      <div class="mt-3 mb-3">
        <div class="row mb-3">
            <div class="col-md-6"><!-- Tipo de Kit 4001-4004 -->
                ...
                <input type="text" id="kitType" class="form-control" value="<?php if(isset($kitType)){echo $kitType;}?>" disabled>
            </div>
            <div class="col-md-6"><!-- $Mensualidad -->
                <p class="label-custom">Mensualidad $(IVA incluido):</p>
                <input type="text" id="kitMensualidad" class="form-control" value="<?php if(isset($kitPrice)){echo $kitPrice;}?>" disabled>
            </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" id="acuerdoPago" class="form-control" value="Pago inicial del depósito y 1 mes" disabled>
            </div>
            <div class="col-md-3">
                <p class="label-custom">Modalidad:</p>
                <input type="text" id="modalidad" class="form-control" value="Leasing" disabled>
            </div>
            <div class="col-md-3">
                <p class="label-custom">Frecuencia de Pago:</p>
                <input type="text" id="frecuenciaPago" class="form-control" value="Mensual" disabled>
            </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="date" id="fechaInicio" class="form-control" value='<?php echo date('Y-m-d'); ?>' disabled>
            </div>

            <div class="col-md-6">
                <p class="label-custom">Metodo de Pago:</p>
      ...
      <div class="mt-3 mb-3">
        <div class="row mb-3">
            <div class="col-md-6">
               ...
               <input type="text" id="contacto1" class="form-control" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+" required> 
               <div class="invalid-feedback">Introduce contacto</div>
            </div>
            <div class="col-md-6">
               <p class="label-custom">Teléfono 1:</p>
               <input type="number" id="telefono1" class="form-control sinBotonera" required>  
               <div class="invalid-feedback">Introduce teléfono</div> 
            </div>
        </div>
      </div>
      ...
      <div>
        <div class="row mb-3">
            <div class="col-md-6">
               ...
               <input type="text" id="contacto2" class="form-control" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+" required> 
               <div class="invalid-feedback">Introduce contacto</div>
            </div>
            <div class="col-md-6">
               <p class="label-custom">Teléfono 2:</p>
               <input type="number" id="telefono2" class="form-control sinBotonera" required>   
               <div class="invalid-feedback">Introduce teléfono</div>
            </div>
        </div>
      </div>
      ...
      <div id="datosBancarios">
        ...
        <div class="mb-3"><!-- Campos de datos bancarios y tarjeta -->
            <div class="container-flui">
              <div class="row">
                <div class="col-12 mb-3" id="tajertaPago">
                ...
                <div class="col-12 mt-3">
                  ...
                  <label class="mb-2" for="name">Datos del titular de la tarjeta</label>

                    <div class="col-12 mb-3">
                      <label for="nameTitular">Nombres(s)</label>
                      <input id="nameTDC" type="text" name="nameTitular" class="form-control" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+" required/>
                      <div class="invalid-feedback">Introduce nombre de titular</div>
                    </div>

                    <div class="col-8">
                      <label for="expirationdate">Calle</label>
                      <input
                        id="calleTDC"
                        type="text"
                        name="calleTDC"
                        ...
                        required
                      />
                      <div class="invalid-feedback">Introduce calle</div>
                    </div>

                    <div class="col-4">
                      <label for="securitycode">Codigo Postal</label>
                      <input
                        id="cpTDC"
                        type="number"
                        name="cpTDC"
                        ...
                        required
                      />
                      <div class="invalid-feedback">Introduce codigo postal</div>
                    </div>

                    <div class="col-4">
                      <label for="municipioTDC">Municipio/Alcaldía</label>
                      <input
                        id="municipioTDC"
                        type="text"
                        name="municipioTDC"
                        ...
                        disabled
                      />
                      <div class="invalid-feedback">Introduce minicipio/alcaldía</div>
                    </div>

                    <div class="col-4">
                      <label for="expirationdate">Estado</label>
                      <input
                        id="estadoTDC"
                        type="text"
                        name="estadoTDC"
                        ...
                        disabled
                      />
                      <div class="invalid-feedback">Introduce estado</div>
                    </div>

                    <div class="col-4">
                      <label for="securitycode">Colonia</label>
                      <select class="form-select" id="coloniaTDC" name="coloniaTDC" aria-label="Default select example" required>
                        <option selected disabled>Selecciona tu colonia:</option>
                      </select>
                    </div>
                    ...
                    <div class="col-12 position-relative">
                      ...
                      <input
                        ...
                        required
                      />
                      <div class="invalid-feedback">Introduce número de tarjeta</div>
                      <svg
                        id="ccicon"
                        class="position-absolute top-0 start-80 ccicon"
                        height="471"
                        viewBox="0 0 750 471"
                        version="1.1"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-6">
                      ...
                      <input
                        ...
                        required
                      />
                      <div class="invalid-feedback">Introduce fecha de expiración</div>
                    </div>
                    <div class="col-6">
                      ...
                      <input
                        ...
                        autocomplete="nope"
                      />
                      <div class="invalid-feedback">Introduce CCV</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row mt-3 text-center"><!-- Informacion de proveedor bancario -->
            <div class="col-sm-12">
              <div id="tarjetaHelp" class="form-text">Transacciones realizadas vía</div>
              <img class="form-text" src="images/logos/openpay.png"/>
            </div>
            <div class="col-sm-12 mt-2">
              <div class="row">
                <div class="col-12">
                  <div id="tarjetaHelp" class="form-text">
                    Tus pagos se realizan de forma segura con encriptación de 256 bits
                  </div>
                </div>
                <div class="col-12">
                  <img class="form-text" src="images/logos/security.png" />
                </div>
              </div>
            </div>
        </div>
      ...
      <div class="container-sm d-flex justify-content-center align-items-center mt-5">
          <button type="button" id="btnContinuar" class="btn btn-primary btn-custom text-center" onClick="registerUser()"></button>
      </div>
...
<script>
  ...
  const elemento2 = document.getElementById('cpTDC');
  let selectColonia2 = document.getElementById('coloniaTDC');

  function miFuncion() {
      $.ajax({
						url: '../quoteAssistant/resources/api_cp/cp.php',
						type: 'POST',
            dataType: 'json',
            data:{
              codigoPostal:$('#cp').val()
  ...
  function miFuncion2() {
      $.ajax({
            ...
            data:{
              ...
              console.log(result); 
              $('#estadoTDC').val(result.codigo_postal.estado)
              $('#municipioTDC').val(result.codigo_postal.municipio)
              ...
              for(let i=0; i<=colonia.length-1; i++){
                ...
                nuevaOpcion.value = result.codigo_postal.colonias[i];
                nuevaOpcion.textContent = result.codigo_postal.colonias[i]; 
                selectColonia2.appendChild(nuevaOpcion);
              }
						}
					});
  }
  ...
  elemento2.addEventListener('change', miFuncion2);
</script>

<!-- CALCULA TAMAÑO DE ARCHIVOS -->
<script>
  ...
  $(document).ready(function() {
    ...
    $("#metodoPago").change(function() {
      if($(this).val() == 3) 
      {
        ...
        $('#calleTDC').attr('required', true);
        $('#coloniaTDC').attr('required', true);
        $('#estadoTDC').attr('required', true);
      ...
      else
      {
        ...
        $('#calleTDC').removeAttr('required');
        $('#coloniaTDC').removeAttr('required');
        $('#estadoTDC').removeAttr('required');
    ...
    //SCRIPT DE CONTROL DE TARJETA 
      const name = document.getElementById('nameTDC');
