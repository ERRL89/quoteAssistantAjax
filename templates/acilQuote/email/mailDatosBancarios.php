                                                ...
                                                <tr>
                                                  <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                    ...
                                                    <div class='space-y-3'>
                                                      ...
                                                      <p class='text-dark text-justify' style='line-height: 24px; font-size: 16px; color: #1a202c; width: 100%; margin: 0;' align='justify'>
                                                        Quiero expresarte mi m&#225;s sincero agradecimiento por considerar a ACIL como tu proveedor de servicios de seguridad. Tu inter&#233;s en nuestros servicios nos llena de gratitud y confianza en nuestra capacidad para satisfacer tus necesidades.
                                                      </p>
                                                      <table class='s-3 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                        <tbody>
                                                          <tr>
                                                      ...
                                                      <p class='text-dark text-justify' style='line-height: 24px; font-size: 16px; color: #1a202c; width: 100%; margin: 0;' align='justify'>
                                                        Adjunto a este correo electr&#243;nico, encontrar&#225;s los detalles bancarios necesarios para completar tu pago.
                                                      </p>
                                                      <table class='s-3 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                        <tbody>
                                                          <tr>
                                                      ...
                                                      <p class='text-dark text-justify' style='line-height: 24px; font-size: 16px; color: #1a202c; width: 100%; margin: 0;' align='justify'>
                                                        Una vez m&#225;s, agradezco sinceramente tu inter&#233;s en ACIL y esperamos tener la oportunidad de servirte pronto. No dudes en ponerte en contacto con nosotros si necesitas m&#225;s informaci&#243;n o asistencia.
                                                      </p>
                                                      <table class='s-3 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                        <tbody>
                                                          <tr>
